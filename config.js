...
module.exports = {
  ...
  PORT: toBool(process.env.PORT) || 254717646309,
  PM_BLOCKER: toBool(process.env.PM_BLOCKER) || true,
  ...
  SESSION_ID: process.env.SESSION_ID || 'Jarvis_fb8a_b1be_c087_5436_e53c_29ea_62ad_a0e3',
  ...
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || 'manu',
